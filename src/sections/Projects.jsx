...
const projects = [
  {
    ...
    description:
      "The Residential Wastewater Management System (RWMS) integrates filtration with real-time water monitoring. I built the web system and IoT connection to visualize data and control the system in real time.",
    images: [
    ...
    <section id="projects" className="py-32 relative overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto px-8 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          Featured <span className="text-foreground">Works</span>
          </span>
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1 space-y-2">
                <div className="flex items-start justify-between">
                  <h3 className="text-xl font-regular tracking-wide group-hover:text-primary transition-colors">
                    {project.title}
                  </h3>
                </div>
